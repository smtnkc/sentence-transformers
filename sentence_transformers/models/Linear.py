...
class Linear(nn.Module):
    """Feed-forward function without activiation function.
    ...
    """
    def __init__(self, in_features: int, out_features: int, bias: bool = True, init_weight: Tensor = None, init_bias: Tensor = None):
    ...
    def forward(self, features: Dict[str, Tensor]):
        features.update({'sentence_embedding': self.linear(features['sentence_embedding'])})
        return features
    ...
    def get_config_dict(self):
        return {'in_features': self.in_features, 'out_features': self.out_features, 'bias': self.bias}
    ...
    def __repr__(self):
        return "Linear({})".format(self.get_config_dict())
